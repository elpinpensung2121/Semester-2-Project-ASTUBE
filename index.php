...
$query=mysql_query("select * from video order by id_video desc limit $posisi,$batas");
while($r=mysql_fetch_array($query))
{
echo"<div class='col-md-4 mb-5'>
										<div class='card'>
                                        <div class='text-center'><a href='watch.php?id=$r[id_video]&filenya=$r[video]'>
                                        <img class='card-img-top w-50'
                                        src='video/$r[thumb]' alt='Video' width=500 height=150>
                                        </a>
										<div class='text-center'>
										<strong>$r[nama_video]</strong><br>
										$r[kategori]<br>
										<a href='watch.php?id=$r[id_video]&filenya=$r[video]'>Watch</a>
										</div>
										</div>
                                        </div>

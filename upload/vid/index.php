...
<td bgcolor="#000048"><span class="style1"><a href="#"onClick="logout()"><strong>- Logout</strong></a></span></td>
      ...
      <td width="753" height="250" align="left" bgcolor="#FFFFFF"><div align="center">KATEGORI PRODUK
        ...
        <tr>
          <td>&nbsp;</td>
          <td><p align="left"><a href="input_produk.php">+ Tambah Produk </a></p>
            <p>
              <?php
include "../koneksi.php";

$query = "select * from kategori,produk 
where produk.kategori=kategori.id_kategori ";
...
?>
            <table border="0">
              <tr bgcolor="#B0B0B0">
                ...
                <th><small>Tgl Masuk </small></th>
                <th><small>Dibeli</small></th>
...
?>
              <tr bgcolor="#E4E4E4">
                ...
                <td><small><?php echo $data['nama_produk']; ?></small></td>
                <td><small><?php echo $data['deskripsi']; ?></small></td>
                <td><small><?php echo $data['harga']; ?></small></td>
                <td><small><?php echo $data['stock']; ?></small></td>
                <td><small><?php echo $data['tgl_masuk']; ?></small></td>
                <td><small><?php echo $data['dibeli']; ?></small></td>
                <td><small><?php echo $data['gambar']; ?></small></td>
                <td><small><a href="hapus_produk.php?id=<?php echo $data['id_produk']; ?>" 
	onClick = "return confirm('Apakah Anda ingin mengapus data <?php echo $data['id_produk']; ?>?')"> Hapus </a> | <a href="edit_produk.php?id=<?php echo $data['id_produk']; ?>" >Edit</a> </small></td>
              </tr>
              <?php
$no++;
}
?>
    ...
    <tr align="center" valign="middle" bgcolor="#000099">
      <td colspan="2"><span class="style1">&copy; 2019 <br>
design by Elpin Peng Sung | Owen Mora </span></td>
    </tr>
  </table>
</div>
</body>
